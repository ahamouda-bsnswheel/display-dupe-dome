...
const translations = {
  en: {
    ...
    "taskSettings.taskName": "Task Name",
    "taskSettings.taskNameHint": "Give your task a clear, descriptive name",
    "taskSettings.taskNamePlaceholder": "Enter task name...",
    "taskSettings.taskStage": "Task Stage",
    "taskSettings.taskStageHint": "Select the current stage of your task",
    "taskSettings.assignees": "Assignees",
    "taskSettings.assigneesPlaceholder": "Select assignees...",
    "taskSettings.tags": "Tags",
    "taskSettings.tagsPlaceholder": "Select tags...",
    "taskSettings.deadline": "Deadline",
    "taskSettings.plannedHours": "Planned Hours",
    "taskSettings.description": "Description",
    "taskSettings.descriptionPlaceholder": "Task description...",
    "taskSettings.activity": "Activity",
    "taskSettings.activityPlaceholder": "Activity log will be available here.",
    "taskSettings.timesheet": "Timesheet",
    "taskSettings.timesheetPlaceholder": "Timesheet information will be available here.",
    ...
    "taskSettings.saveSuccess": "Task settings saved successfully",
  },
  ar: {
    // Login Page
    ...
    "taskSettings.taskName": "اسم المهمة",
    "taskSettings.taskNameHint": "أعطِ مهمتك اسمًا واضحًا ووصفيًا",
    "taskSettings.taskNamePlaceholder": "أدخل اسم المهمة...",
    "taskSettings.taskStage": "مرحلة المهمة",
    "taskSettings.taskStageHint": "اختر المرحلة الحالية لمهمتك",
    "taskSettings.assignees": "المكلفون",
    "taskSettings.assigneesPlaceholder": "اختر المكلفين...",
    "taskSettings.tags": "العلامات",
    "taskSettings.tagsPlaceholder": "اختر العلامات...",
    "taskSettings.deadline": "الموعد النهائي",
    "taskSettings.plannedHours": "الساعات المخططة",
    "taskSettings.description": "الوصف",
    "taskSettings.descriptionPlaceholder": "وصف المهمة...",
    "taskSettings.activity": "النشاط",
    "taskSettings.activityPlaceholder": "سيتوفر سجل النشاط هنا.",
    "taskSettings.timesheet": "الجدول الزمني",
    "taskSettings.timesheetPlaceholder": "ستتوفر معلومات الجدول الزمني هنا.",
    ...
    "taskSettings.save": "حفظ",
    "taskSettings.saveSuccess": "تم حفظ إعدادات المهمة بنجاح",
  },
};
