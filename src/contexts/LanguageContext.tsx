...
const translations = {
  en: {
    ...
    "projectSettings.deleteSuccess": "Project deleted successfully",
    ...
    "tasks.createTaskError": "Failed to create task",
    ...
    "taskSettings.addTimesheet": "Add Timesheet",
    "taskSettings.editTimesheet": "Edit Timesheet",
    "taskSettings.timesheetName": "Name",
    "taskSettings.timesheetNamePlaceholder": "Enter timesheet name...",
    "taskSettings.timesheetDate": "Date",
    "taskSettings.timesheetHours": "Hours",
    "taskSettings.timesheetCreated": "Timesheet created successfully",
    "taskSettings.timesheetUpdated": "Timesheet updated successfully",
    "taskSettings.timesheetCreateError": "Failed to create timesheet",
    "taskSettings.timesheetUpdateError": "Failed to update timesheet",
    "taskSettings.timesheetDeleteError": "Failed to delete timesheet",
    "taskSettings.deleteTimesheetTitle": "Delete Timesheet?",
    "taskSettings.deleteTimesheetMessage": "This action cannot be undone. This will permanently delete the timesheet entry.",
  ...
  ar: {
    ...
    "projectSettings.deleteSuccess": "تم حذف المشروع بنجاح",
    "projectSettings.deleteError": "فشل في حذف المشروع",
    ...
    "tasks.createTaskError": "فشل في إنشاء المهمة",
    "tasks.searchPlaceholder": "البحث في المهام...",
    "tasks.stage": "مرحلة",
    ...
    "taskSettings.addTimesheet": "إضافة سجل وقت",
    "taskSettings.editTimesheet": "تعديل سجل الوقت",
    "taskSettings.timesheetName": "الاسم",
    "taskSettings.timesheetNamePlaceholder": "أدخل اسم سجل الوقت...",
    "taskSettings.timesheetDate": "التاريخ",
    "taskSettings.timesheetHours": "الساعات",
    "taskSettings.timesheetCreated": "تم إنشاء سجل الوقت بنجاح",
    "taskSettings.timesheetUpdated": "تم تحديث سجل الوقت بنجاح",
    "taskSettings.timesheetCreateError": "فشل في إنشاء سجل الوقت",
    "taskSettings.timesheetUpdateError": "فشل في تحديث سجل الوقت",
    "taskSettings.timesheetDeleteError": "فشل في حذف سجل الوقت",
    "taskSettings.deleteTimesheetTitle": "حذف سجل الوقت؟",
    "taskSettings.deleteTimesheetMessage": "لا يمكن التراجع عن هذا الإجراء. سيتم حذف إدخال سجل الوقت نهائياً.",
